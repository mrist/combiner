...
public class SRLMain {
	public static void main(String[] args) {
		...
		try {
			runPipeline(
					createReaderDescription(TextReader.class, TextReader.PARAM_SOURCE_LOCATION, "input",
					...
					createEngineDescription(JsonWordWriter.class, JsonWordWriter.PARAM_TARGET_LOCATION, "dep/"));
